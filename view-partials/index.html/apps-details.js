function get_all_apps_html(t){let s="";var a=[!0,!0,!0,!1];i=0;for(app_name of["rencontre","incidents-route","hdassist","testsassist"]){var e=a[i],e=get_this_app_html(i,app_name,t,e);s+=e,i++}return s}function get_this_app_html(t,s,a,i){return`
